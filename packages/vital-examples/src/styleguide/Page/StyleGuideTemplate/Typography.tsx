...
import { exampleTypography } from '../../../customizing-design-tokens';
...
const TypographyVariations = {
  H1: withDesign({ Parent: exampleTypography.H1 }),
  H2: withDesign({ Parent: exampleTypography.H2 }),
  H3: withDesign({ Parent: exampleTypography.H3 }),
  H4: withDesign({ Parent: exampleTypography.H4 }),
  H5: withDesign({ Parent: exampleTypography.H5 }),
  Body: withDesign({ Parent: exampleTypography.Body }),
  Eyebrow: withDesign({ Parent: exampleTypography.Eyebrow }),
  Gradient: withDesign({ Parent: exampleTypography.Gradient }),
  Rest: withDesign({ Parent: exampleTypography.Rest }),
};
