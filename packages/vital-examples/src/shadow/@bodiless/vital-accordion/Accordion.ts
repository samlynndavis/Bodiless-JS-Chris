...
const Default = asAccordionToken(
  ...
  exampleAccordion.Default, {
    Compose: {
      WithShadowedBy: addProps({ 'data-shadowed-by': 'exampleAccordion' }),
    },
  }
);
...
const WithFAQSchema = asAccordionToken(
  ...
  exampleAccordion.WithFAQSchema, {
    Compose: {
      WithShadowedBy: addProps({ 'data-shadowed-by': 'exampleFAQAccordion' }),
    },
  }
);
