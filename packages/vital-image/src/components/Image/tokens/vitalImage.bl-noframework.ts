...
export const withImageClientLoader = identity;
export const withoutImageProps = identity;
export const asImage = identity;
export const withImageLogger = identity;
export const withImageNode = (preset: ImagePresets) => identity;
