...
import { ifReadOnly } from '../withEditToggle';
import withData from '../withData';
import type { UseBodilessOverrides } from '../Types/EditButtonTypes';
import { withBodilessData } from './withBodilessData';
import type { BodilessOptions, AsBodiless } from '../Types/AsBodilessTypes';
import { withEditor } from './asBodilessComponent.edit';
...
const asBodilessComponent = <P extends object, D extends object>(options: BodilessOptions<P, D>): AsBodiless<P, D> => (
  ...
  (
    ...
    const withEditorFinal = process.env.NODE_ENV === 'production' 
      ? identity : withEditor(options)(nodeKeys, defaultData, useOverrides);
