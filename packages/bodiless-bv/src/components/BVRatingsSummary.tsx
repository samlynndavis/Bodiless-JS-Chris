...
const BVPlainRatingsSummary: FC<Props> = ({ productId, ...rest }) => <div id="BVRRSummaryContainer" {...rest} />;

export const BVRatingsSummaryBase = asBVComponent('BV Ratings Summary', onLoaded)(BVPlainRatingsSummary);
