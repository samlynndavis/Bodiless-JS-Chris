...
const TopNav = asMenuToken(vitalMenuBase.TopNav, {
  Core: {
    _: addProps({ 'data-shadowed-by': 'vital-demo:Menu_TopNav' }),
  },
});

const Footer = asMenuToken(vitalMenuBase.Footer, {
  Core: {
    _: addProps({ 'data-shadowed-by': 'vital-demo:Menu_Footer' }),
  },
});

const Utility = asMenuToken(vitalMenuBase.Utility, {
  Core: {
    _: addProps({ 'data-shadowed-by': 'vital-demo:Menu_Utility' }),
  },
});
