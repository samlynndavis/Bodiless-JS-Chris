...
const Basic = asCardToken(vitalCardBase.Basic, {
  Behavior: {
    Wrapper: addProps({ 'data-shadowed-by': 'vital-demo:Card:Basic' }),
  },
});

const Hero = asCardToken(vitalCardBase.Hero, {
  Behavior: {
    Wrapper: addProps({ 'data-shadowed-by': 'vital-demo:Card:Hero' }),
  },
});

const HeroLeftImageContentCentered = asCardToken(vitalCardBase.HeroLeftImageContentCentered, {
  Content: {
    Title: addProps({ 'data-shadowed-by': 'vital-demo:Card:HeroLeftImageCentered' }),
  },
});
